...
text_model_name = 'ckpt/clip_vit_base_patch32'
# Polygon2Mask
downsample_ratio = 4
mask_overlap = False
...
coco_train_dataset = dict(
    ...
    dataset=dict(type='YOLOv5FusaiV1Dataset',
                 data_root='data/coco',
                 ann_file='QY/train_coco.json',
                 data_prefix=dict(img=''),
                 filter_cfg=dict(filter_empty_gt=True, min_size=32)),
    class_text_path='data/texts/fusai_class_texts.json',
...
val_dataloader = dict(dataset=coco_val_dataset,batch_size=1)
test_dataloader = val_dataloader

val_evaluator = dict(type='mmdet.LVISMetric',
                     ann_file='data/coco/QY/train_coco.json',
                     metric=['bbox', 'segm'])
